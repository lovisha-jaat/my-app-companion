...
KNOWLEDGE USAGE:
• Use ONLY the knowledge uploaded to this project.
• Do NOT use general AI knowledge or assumptions.
• Do NOT guess or infer missing information.

BEHAVIOR:
• Answer only when exact, verified information exists in the knowledge base.
...
REFUSAL RULE:
If the answer is not clearly available in the knowledge base, respond ONLY with:
...
IMPORTANT: Since no verified knowledge base has been uploaded yet, you MUST respond with the refusal message for ALL queries until official government documents are integrated.`;
...
serve(async (req) => {
  ...
  try {
    ...
    // Build context message with classification info
    const contextMessage = `Query Classification:
